...
const CalendarConfirmationPage = () => {
  ...
  return (
    <div className="opportunity-confirmation-page">
      <div className="opportunity-confirmation-container">
        ...
        <h1>Added to Google Calendar!</h1>

        <p>This opportunity has been added to your Google Calendar.</p>
...
export default CalendarConfirmationPage;
